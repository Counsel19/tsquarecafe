...
const page: FC<pageProps> = ({}) => {
  return (
    <div className="flex justify-center h-[90%]">
      <div className="grid lg:grid-cols-[1fr_400px] max-h-[400px] my-16 rounded-lg">
            ...
            <div className="flex gap-6 items-center">
              ...
              <div className="space-y-px">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className={`${buttonVariants()} bg-green-200 hover:bg-green-300 text-slate-900`}
                >
                  <Image
        ...
        <div className="bg-gradient-to-r from-slate-500 to-teal-500 flex-1 rounded-r-lg ">
