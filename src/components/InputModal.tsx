...
import {
  ...
  verifyByPhone,
  verifyByVNIN,
} from "@/lib/redux/slices/service/thunk";
...
const InputModal: FC = ({}) => {
  ...
  const {
    selectedService: { title: serviceType },
    ...
    try {
      if (!input) {
        ...
        if (res?.status == 201 && res?.data) {
          ...
          if (verificationResult?.type === "services/verifyByNIN/rejected") {
            return toast({
              title: "Verification Failed",
      ...
      <div className="flex justify-center items-center h-full">
        ...
        >
          <div className="m-4 flex justify-between items-center">
            <h3 className="font-semibold">Verification By Virtual NIN</h3>
            <button
